...
module.exports = function initialize(shim, nextServer) {
  ...
  shim.record(Server.prototype, 'handleRequest', function wrapRequest(shim, handleRequest, name, args) {
    return {
      req: args[0],
      res: args[1],
  ...
  shim.record(Server.prototype, 'renderToResponse', function wrapRequest(shim, renderToResponse, name, args) {
    debugger
  })

  shim.record(Server.prototype, 'handleApiRequest', function wrapRequest(shim, handleApiRequest, name, args) {
